...
- [`make_block()`](#ocracy.make_backend.make_block) / [`as_bbox()`](#ocracy.make_backend.as_bbox) — build normalized [`TextBlock`](ocracy.base.html.md#ocracy.base.TextBlock)
  / [`BBox`](ocracy.base.html.md#ocracy.base.BBox) from whatever shape the engine returned, including
...
| [`make_block`](#ocracy.make_backend.make_block)(text, \*[, bbox, confidence, ...])   | Build a normalized [`TextBlock`](ocracy.base.html.md#ocracy.base.TextBlock).     |
|--------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------|
| [`as_bbox`](#ocracy.make_backend.as_bbox)(obj)                                    | Coerce common bbox shapes into a [`BBox`](ocracy.base.html.md#ocracy.base.BBox). |
...
* **Return type:**
  [`Optional`](https://docs.python.org/3/library/typing.html#typing.Optional)[[`BBox`](ocracy.base.html.md#ocracy.base.BBox)]
...
* **Parameters:**
  ...
  * **ledger** ([`Any`](https://docs.python.org/3/library/typing.html#typing.Any)) – A [`Catalog`](ocracy.html.md#ocracy.Catalog) to read the record from
