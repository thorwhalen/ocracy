...
1. **A uniform facade.** Call [`ocr()`](#ocracy.ocr) and get the same [`OcrResult`](ocracy.base.html.md#ocracy.base.OcrResult)
...
| [`make_block`](#ocracy.make_block)(text, \*[, bbox, confidence, ...])    | Build a normalized [`TextBlock`](ocracy.base.html.md#ocracy.base.TextBlock).      |
...
* **Return type:**
  [`BBox`](ocracy.base.html.md#ocracy.base.BBox)
...
* **Return type:**
  [`List`](https://docs.python.org/3/library/typing.html#typing.List)[[`TextBlock`](ocracy.base.html.md#ocracy.base.TextBlock)]
...
Build a normalized [`TextBlock`](ocracy.base.html.md#ocracy.base.TextBlock).
...
* **Return type:**
  [`TextBlock`](ocracy.base.html.md#ocracy.base.TextBlock)
...
* **Return type:**
  [`OcrResult`](ocracy.base.html.md#ocracy.base.OcrResult)
* **Returns:**
  An [`OcrResult`](ocracy.base.html.md#ocracy.base.OcrResult) (`str(result)` is the text).
...
[`OcrResult`](ocracy.base.html.md#ocracy.base.OcrResult) came back with text and/or blocks. Never
...
| [`backends`](ocracy.backends.html.md#module-ocracy.backends)         | Implemented OCR backends.                                                                                        |
|------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------|
...
| [`tools`](ocracy.tools.html.md#module-ocracy.tools)               | Command-line tools for ocracy (dispatched via `cw` in `__main__`).                                               |
| [`translation`](ocracy.translation.html.md#module-ocracy.translation)   | Parameter translation between ocracy's normalized kwargs and native engines.                                     |
| [`util`](ocracy.util.html.md#module-ocracy.util)                 | Image-input normalization and small shared helpers.                                                              |
